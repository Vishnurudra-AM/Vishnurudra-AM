...
icon = Image.open("YPL.png.png")
st.set_page_config(page_title="Youtube Data Harvesting and Warehousing | By VISHNURUDRA AM",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This App is created by VISHNURUDRA AM!*"""})
...
api_key = "AIzaSyBhruH52vbjz_UwA5tBpNSXD10ruhIHTdY"
